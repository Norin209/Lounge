    ...
    <div className="bg-white min-h-screen pb-24 relative">
      ...
      <section className="relative h-[45vh] md:h-[50vh] w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-0 text-center px-6">
          ...
          <p className="text-white/70 text-[9px] md:text-[10px] tracking-[0.4em] uppercase font-light">Handcrafted Cambodian Wellness</p>
        </div>
      </section>
          ...
          {filteredItems.length > 0 ? (
            filteredItems.map((item) => {
                ...
                >
                  ...
                  `}>
                    <div>
                      ...
                      `}>
                        {item.description || "Handcrafted botanical wellness."}
                      </p>
                    </div>
             ...
             <div className="col-span-full py-20 flex flex-col items-center justify-center text-gray-400">
               ...
               <p className="text-[11px] uppercase tracking-widest italic">No products found.</p>
             </div>
          )}
        </div>
      </main>
